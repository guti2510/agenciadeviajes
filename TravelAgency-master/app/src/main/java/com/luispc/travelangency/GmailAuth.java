...
public class GmailAuth extends Activity implements OnClickListener,
    ...
    //Initializes the google plus client to make requests
    ...
    //Gets the UI components an store them into variables
    ...
    // Sets the button click listernes (login/logout)
    ...
    private void getProfileInformation() {
        try {
            if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
                ...
                txtName.setText("Agencia de viajes Tu Ruta: \n" + personName);
    ...
    private void signOutFromGplus() {
        if (mGoogleApiClient.isConnected()) {
            ...
            mGoogleApiClient.disconnect();
            mGoogleApiClient.connect();
            ((global) this.getApplication()).setEmail("");
            updateUI(false);
        }
    }
